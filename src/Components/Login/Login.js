    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            ...
            if (status.mode == 'Login') {
                axios.post('http://localhost:3001/users', { values: values, token: tokenId })
        ...
        <>
            ...
            <div style={{ padding: '10px 0' }}>
                <div className='d-flex flex-wrap justify-content-center my-5 w-50' style={{ border: '1px solid lightGrey', margin: 'auto', borderRadius: '15px', padding: '30px 0', backgroundColor: 'white' }}>
                    ...
                    <button className="btn btn-danger col-md-10 ml-2 mb-3" onClick={handleClick} >Swtich to {status.mode == 'Signup' ? 'Login' : 'SignUp'}</button>
